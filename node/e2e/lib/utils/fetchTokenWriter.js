...
function fetchTokenWriter(struct) {
    return __awaiter(this, void 0, void 0, function () {
        var accountName, tokenName, tokenAddress, tokenContractWriter;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountName = struct.accountName, tokenName = struct.tokenName;
                    if (!tokenContractWriters[accountName]) {
                        tokenContractWriters[accountName] = {};
                    }
                    if (tokenContractWriters[accountName][tokenName]) {
                        return [2 /*return*/, tokenContractWriters[accountName][tokenName]];
                    }
                    return [4 /*yield*/, fetchOrDeployTokenAddress_1.fetchOrDeployTokenAddress(tokenName)];
                case 1:
                    tokenAddress = _a.sent();
                    tokenContractWriter = new pollenium_toadflax_1.TokenWriter({
...
exports.fetchTokenWriter = fetchTokenWriter;
