...
function fetchTokenReader(tokenName) {
    return __awaiter(this, void 0, void 0, function () {
        var tokenAddress, tokenContractReader;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (tokenContractReaders[tokenName]) {
                        return [2 /*return*/, tokenContractReaders[tokenName]];
                    }
                    return [4 /*yield*/, fetchOrDeployTokenAddress_1.fetchOrDeployTokenAddress(tokenName)];
                case 1:
                    tokenAddress = _a.sent();
                    tokenContractReader = new pollenium_toadflax_1.TokenReader({
...
exports.fetchTokenReader = fetchTokenReader;
